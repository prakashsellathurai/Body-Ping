...
class LunchModel  extends Equatable {
  ...
  factory LunchModel.fromJson(Map<String, dynamic> _json) {
...
class AutogeneratedLunch {
  final List<LunchModel> results;

  AutogeneratedLunch({this.results});

  factory AutogeneratedLunch.fromJson(Map<String, dynamic> json) {
    List<LunchModel> temp;
    if (json['results'] != null) {
      temp = <LunchModel>[];
      json['results'].forEach((v) {
        temp.add(LunchModel.fromJson(v as Map<String, dynamic>));
      });
    }
    return AutogeneratedLunch(results: temp);
  }
