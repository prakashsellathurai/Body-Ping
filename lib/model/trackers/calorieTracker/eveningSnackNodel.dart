...
class EveningSnackModel extends Equatable{
  ...
  factory EveningSnackModel.fromJson(Map<String, dynamic> _json) {
...
class AutogeneratedEveningSnack {
  final List<EveningSnackModel> results;

  AutogeneratedEveningSnack({this.results});

  factory AutogeneratedEveningSnack.fromJson(Map<String, dynamic> json) {
    List<EveningSnackModel> temp;
    if (json['results'] != null) {
      temp = <EveningSnackModel>[];
      json['results'].forEach((v) {
        temp.add(EveningSnackModel.fromJson(v as Map<String, dynamic>));
      });
    }
    return AutogeneratedEveningSnack(results: temp);
  }
