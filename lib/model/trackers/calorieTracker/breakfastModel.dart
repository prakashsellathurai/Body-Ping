...
class BreakFastModel extends Equatable  {
  ...
  factory BreakFastModel.fromJson(Map<String, dynamic> _json) {
    ...
    return BreakFastModel(
        meal_list: NutritionDatabaseModelList.fromList(_json['meal_list'])
            .nutritionDatabaseModelList,
  ...
  List<Object> get props => [this.meal_list,
      this.calories_list,
      this.quantities_in_grams,
      this.total_calories,
...
class AutogeneratedBreakFast {
  final List<BreakFastModel> results;

  AutogeneratedBreakFast({this.results});

  factory AutogeneratedBreakFast.fromJson(Map<String, dynamic> json) {
    List<BreakFastModel> temp;
    if (json['results'] != null) {
      temp = <BreakFastModel>[];
      json['results'].forEach((v) {
        temp.add(BreakFastModel.fromJson(v as Map<String, dynamic>));
      });
    }
    return AutogeneratedBreakFast(results: temp);
  }
