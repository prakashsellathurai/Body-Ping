...
class DinnerModel extends Equatable{
  ...
  factory DinnerModel.fromJson(Map<String, dynamic> _json) {
...
class AutogeneratedDinner {
  final List<DinnerModel> results;

  AutogeneratedDinner({this.results});

  factory AutogeneratedDinner.fromJson(Map<String, dynamic> json) {
    List<DinnerModel> temp;
    if (json['results'] != null) {
      temp = <DinnerModel>[];
      json['results'].forEach((v) {
        temp.add(DinnerModel.fromJson(v as Map<String, dynamic>));
      });
    }
    return AutogeneratedDinner(results: temp);
  }
