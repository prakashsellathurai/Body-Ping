            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: DashboardTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [DashboardTheme.nearlyDarkBlue.withOpacity(0.2), DashboardTheme.nearlyDarkBlue.withOpacity(0.5)],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [DashboardTheme.nearlyDarkBlue.withOpacity(0.4), DashboardTheme.nearlyDarkBlue],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
                  borderRadius: BorderRadius.only(
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: DashboardTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: DashboardTheme.white.withOpacity(animationController.status == AnimationStatus.reverse ? 0.0 : 0.4),
                    shape: BoxShape.circle,
                  ),
                ),
              ),
