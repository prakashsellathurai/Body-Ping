            ...
            child: Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(color: DashboardTheme.grey.withOpacity(0.2), offset: const Offset(1.1, 1.1), blurRadius: 10.0),
                  ],
                ),
                child: Padding(
                          ...
                          children: <Widget>[
                            Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: <BoxShadow>[
                                  BoxShadow(color: DashboardTheme.nearlyDarkBlue.withOpacity(0.4), offset: const Offset(4.0, 4.0), blurRadius: 8.0),
                                ],
                              ),
                              child: Padding(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: <BoxShadow>[
                              BoxShadow(color: DashboardTheme.grey.withOpacity(0.4), offset: const Offset(2, 2), blurRadius: 4),
                            ],
                          ),
                          child: WaveView(
