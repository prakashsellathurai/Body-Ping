...
class _GroupedBarChartState extends State<GroupedBarChart> {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Text(
            "${values[domain.value]} ml ${domain.value}",
  ...
  Widget _buildBarCharts() {
    double maxValue = [_maxBalance(widget.series[0].data)].reduce(max);
    double factor = 80.0;
    double width = 20.0;
    return Container(
      height: 240.0,
      child: ListView.builder(
        ...
        itemCount: widget.series[0].data.length,
        shrinkWrap: true,
