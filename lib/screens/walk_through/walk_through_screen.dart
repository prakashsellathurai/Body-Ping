...
class WalkThroughScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WalkThroughScreenBody(),
    );
  }
}

class WalkThroughScreenBody extends StatefulWidget {
  WalkThroughScreenBody({Key key}) : super(key: key);

  @override
  WalkThroughScreenBodyState createState() => WalkThroughScreenBodyState();
}

class WalkThroughScreenBodyState extends State<WalkThroughScreenBody> {
